  ...
  return (
    <div className="space-y-6 pb-10">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <h2 className="text-[1.2rem] font-medium text-[#475f7b]">Edit Language</h2>
      ...
      <Card className="border-none shadow-sm bg-white rounded-md">
        <CardContent className="p-8 space-y-6">
          ...
          {/* Submit Button */}
          <div className="pt-6">
            <Button disabled={updateLanguageMutation.isPending} type="submit" className="bg-blue-600 hover:bg-blue-700 text-white px-5 h-10 font-medium rounded-sm-[4px] shadow-sm border-0 flex items-center gap-2">
