                ...
                <TableBody>
                  {languagesData.map((item, index) => (
                    <TableRow key={index} className="border-b border-gray-100 hover:bg-gray-50/50 transition-colors">
                      ...
                      <TableCell className="py-4">
                        {item.isDefault ? (
                          <span className="inline-flex items-center justify-center bg-[#39DA8A] text-white px-3 py-1.5 rounded-[4px] text-[11px] font-bold tracking-wider gap-1">
                            <Check className="w-3.5 h-3.5" />
                            DEFAULT
                          </span>
                        ) : (
                          <button className="inline-flex items-center justify-center bg-transparent border border-[#5A8DEE]/40 text-[#5A8DEE] hover:bg-[#5A8DEE]/10 px-3 py-1.5 rounded-[4px] text-[11px] font-medium transition-colors">
                            Set Default
                          </button>
                        )}
                      </TableCell>
