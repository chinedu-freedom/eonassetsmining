  ...
  return (
    <div className="space-y-6 max-w-4xl">
      <div>
        ...
        <p className="text-slate-400 text-sm">Configure system preferences and administrator details.</p>
      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <input 
                  ...
                  className="w-full bg-[#0B0E14] border border-white/10 rounded-xl py-2 px-4 text-white focus:outline-none focus:border-blue-500/50 transition-colors"
                />
              </div>
              <div className="space-y-2">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-[#0B0E14] rounded-xl border border-white/5">
              <div>
                <h4 className="text-white font-medium mb-1">New User Registrations</h4>
                <p className="text-xs text-slate-500">Receive an email when a new user signs up.</p>
              </div>
            ...
            <div className="flex items-center justify-between p-4 bg-[#0B0E14] rounded-xl border border-white/5">
              <div>
                <h4 className="text-white font-medium mb-1">Deposit Alerts</h4>
                <p className="text-xs text-slate-500">Receive an email for every new deposit request.</p>
              </div>
              <div className="w-10 h-6 bg-blue-600 rounded-full relative cursor-pointer">
                <div className="w-4 h-4 bg-white rounded-full absolute right-1 top-1"></div>
              </div>
